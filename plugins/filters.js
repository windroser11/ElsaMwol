...
const array = ['account poyi','Don','Eee','Good Morning','Hm','offer','poda myre','powli','romantic','sed','song','spam','Ha','Eda','ElsaMwol','Friend','group','Happy','help','Hi','Hlo','jihad','Kali','Kalikkuno','Kundan','Myra','Nanba','nanban','Ntha','Ok','para','photo','poda','really','song','sticker','tha','Thund','Va','Vazhe','video','You','Editor','Malabar','Director','Suii']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
...
const array = ['Alone','avan','Bot','Da','Di','Enthada','friends','Jihad','Life','love','lub','M','Mm','Myr','Myre','Nice','Ningal','Njan','Owner','Para','Please','Poda','pro','Sathyam','Thep','Umm','umma','venda','xxx','malabar kid']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
